...
export default async function decorate(block: HTMLElement): Promise<void> {
    ...
    const firstImage = firstImageWrapper.querySelector('picture') as HTMLElement | null;
    if (firstImage) {
    ...
    const secondImage = secondImageWrapper.querySelector('picture') as HTMLElement | null;
    if (secondImage) {
