...
function decorateTemplateAndTheme() {
    ...
    // Use <yellow-line> and the 'vertical-line-yellow' class will be added
    const yellowLineTag = 'yellow-line';
    const yellowLineClass = 'vertical-line-yellow';
    highlightTextInDocument(yellowLineTag, yellowLineClass);
}
